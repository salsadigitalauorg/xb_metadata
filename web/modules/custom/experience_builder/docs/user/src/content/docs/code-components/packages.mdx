...
<LinkButton
  href="https://git.drupalcode.org/project/experience_builder/-/blob/0.x/ui/lib/astro-hydration/src/lib/FormattedText.tsx"
  variant="minimal"
  icon="external"
>
  Source Code
...
<LinkButton
  href="https://git.drupalcode.org/project/experience_builder/-/blob/0.x/ui/lib/astro-hydration/src/lib/utils.ts"
  variant="minimal"
  icon="external"
>
  Source Code
