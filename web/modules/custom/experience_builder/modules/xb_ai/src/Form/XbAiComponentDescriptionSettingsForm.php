 ...
 */
final class XbAiComponentDescriptionSettingsForm extends ConfigFormBase {
  ...
  /**
   * Creates a new XbAiComponentDescriptionSettingsForm instance.
   *
   * @param \Drupal\xb_ai\XbAiPageBuilderHelper $pageBuilderHelper
   *   The page builder helper.
   */
  public function __construct(
    protected readonly XbAiPageBuilderHelper $pageBuilderHelper,
  ) {
  }
  ...
  public function getFormId(): string {
    return 'xb_ai_component_description_settings';
  }
  ...
  protected function getEditableConfigNames(): array {
    return ['xb_ai.component_description.settings'];
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    foreach ($component_context as $source => $components) {
      ...
      $this->config('xb_ai.component_description.settings')
  ...
  private function buildComponentContextForm(): array {
    ...
    foreach ($usable_components as $source => $source_data) {
      ...
      $form[$source]['enabled'] = [
        ...
        '#default_value' => $this->config('xb_ai.component_description.settings')->get('component_context.' . $source . '.enabled'),
  ...
  private function getComponentContextData(string $source): ?array {
    if (!isset($this->componentContextCache[$source])) {
      $config = $this->config('xb_ai.component_description.settings');
