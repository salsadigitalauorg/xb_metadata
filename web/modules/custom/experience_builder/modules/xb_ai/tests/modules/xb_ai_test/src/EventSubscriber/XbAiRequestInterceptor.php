...
namespace Drupal\xb_ai_test\EventSubscriber;
...
/**
 * Event subscriber to intercept XB AI API requests during tests.
 */
class XbAiRequestInterceptor implements EventSubscriberInterface {
  ...
  /**
   * Intercepts XB AI API requests and returns fixture responses.
   *
  ...
  public function onKernelRequest(RequestEvent $event): void {
    ...
    if (str_starts_with($path, '/admin/api/xb/ai')) {
