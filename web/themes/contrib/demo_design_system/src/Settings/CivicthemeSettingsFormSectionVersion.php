...
class CivicthemeSettingsFormSectionVersion extends CivicthemeSettingsFormSectionBase {
  ...
  public function form(array &$form, FormStateInterface $form_state): void {
    ...
    $form['civictheme_version'] = [
      ...
      '#context' => [
        'content' => $this->t('<div class="messages messages--info">Your CivicTheme (for Starshot) version: @version</div>', [
          //'@version' => Link::fromTextAndUrl($version, Url::fromUri($version_uri))->toString(),
          // Hardcode the logic for the demo.
          '@version' => Link::fromTextAndUrl($version, Url::fromUri('https://git.drupalcode.org/project/demo_design_system'))->toString(),
        ]),
      ],
      '#weight' => -100,
    ];
